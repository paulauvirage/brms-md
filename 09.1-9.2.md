...
## Intercept            0.85      0.59    -0.34     1.99 1.00     3288     2780
## percentage.black     0.11      0.02     0.08     0.14 1.00     3314     2010
## 
## Further Distributional Parameters:
##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## sigma     1.73      0.23     1.34     2.24 1.00     2992     2742
## 
## Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
## and Tail_ESS are effective sample size measures, and Rhat is the potential
## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
## the estimated intercept is: 0.857
## 
## the estimated slope is: 0.106
## 
## the estimated residual standard deviation is: 1.7
## 
## the intercept 90% cis are:
##  5% 95% 
##   0   2 
## 
## the slope 90% cis are:
##  5% 95% 
##   0   0
```
...
```
##                        5%    95%
## b_Intercept         -0.12   1.81
## b_percentage.black   0.08   0.13
## sigma                1.39   2.14
## Intercept            3.82   4.77
## lprior              -3.68  -3.39
## lp__               -67.83 -63.90
...
## 1 (percentage.black) > 0     0.11      0.02     0.08     0.13        Inf         1    *
## ---
...
<img src="09.1-9.2_files/figure-html/unnamed-chunk-11-1.png" width="360" style="display: block; margin: auto;" />
...
<img src="09.1-9.2_files/figure-html/unnamed-chunk-12-1.png" width="720" style="display: block; margin: auto;" />
...
<img src="09.1-9.2_files/figure-html/unnamed-chunk-20-1.png" width="360" style="display: block; margin: auto;" />
